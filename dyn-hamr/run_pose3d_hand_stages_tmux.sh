...
KEYPOINTS_NPY="${KEYPOINTS_NPY:-../outputs/pose3d_hand_stages_0610/${SEQ}_keypoints.npy}"
IMAGE_ROOT="${IMAGE_ROOT:-../outputs/pose3d_hand_stages_0610/${SEQ}_frames}"
...
WORK_DIR="${WORK_DIR:-../outputs/pose3d_hand_stages_0610/${SEQ}}"
OUTPUT="${OUTPUT:-../outputs/pose3d_hand_stages_0610/${SEQ}_export.pose3d_hand}"
