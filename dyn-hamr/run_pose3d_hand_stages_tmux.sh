...
KEYPOINTS_NPY="${KEYPOINTS_NPY:-../outputs/pose3d_hand_stages_0609/${SEQ}_keypoints.npy}"
...
WORK_DIR="${WORK_DIR:-../outputs/pose3d_hand_stages_0609/${SEQ}}"
OUTPUT="${OUTPUT:-../outputs/pose3d_hand_stages_0609/${SEQ}_export.pose3d_hand}"
